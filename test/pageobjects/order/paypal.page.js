class PaypalPage {
  ...
  get btnNext() { return $('//button[@id="btnNext"]'); }
  get passwordField() { return $('#//input[@id="password"]'); }
  get btnLogin() { return $('//button[@id="btnLogin"]'); }
  get btnCompletePurchase() { return $('//button[@class="Buttons_base_2xi07 CheckoutButton_noMargin_mv-3h Buttons_rebrandTreatment1_3-eCu xo-member-c72rwi-button_base-text_button_lg-btn_full_width"]'); }
